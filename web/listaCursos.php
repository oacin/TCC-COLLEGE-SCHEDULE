  ...
  width: 600px;
   ...
   .button {
	...
	<td class="gg"><img src="logo.png" width="300" height="80"></td>
	 <td class="gg">
				<a href="../TCC/cadastrarCurso.php"><button class="btNovo" >Novo Curso</button></br><br>
	...
	<br><br><center><h1>Cursos Cadastrados</h1></center><br>
	<div>
	...
	<thead>
			<tr class="trgg" >
				...
				<th class="gg" align="center">Quantidade de alunos</th>
				<th class="gg" align="center">Periodo</th>
				<th class="gg" align="center">Quantidade de semestres</th>
			</tr>
		</thead>
	...
	<?php
		...
		while($row_veiculo = mysqli_fetch_assoc($result_veiculos)){
			...
			<td class="gg" align="center"><?php echo  $row_veiculo['quantidadeAluno'] ;?></td>
			<td class="gg" align="center"><?php echo   $row_veiculo['periodo'] ;?></td>
			<td class="gg" align="center"><?php echo   $row_veiculo['qtdSemestre'] ;?></td>
			</tr>
			<?php
		}?>
