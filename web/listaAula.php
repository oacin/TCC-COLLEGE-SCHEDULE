...
$result_veiculos = "SELECT curso.nome, turma.name, disciplina.nomeD, professor.nomeP, sala.nomeS, carga, horario, alocado from aula INNER JOIN curso
INNER JOIN turma
  ...
  width: 600px;
   ...
   .button {
	...
	<td class="gg"><img src="logo.png" width="300" height="80"></td>
	 <td class="gg">
				<a href="../TCC/cadastrarAula.php"><button class="btNovo" >Nova Aula</button></br><br>
	...
	<thead>
			<tr class="trgg" >
				...
				<th class="gg" align="center">Carga horaria</th>
				<th class="gg" align="center">Horario</th>
				<th class="gg" align="center">Alocado</th>
	...
	<?php
		...
		while($row_veiculo = mysqli_fetch_assoc($result_veiculos)){
			?>
			<tr class="trgg">
			<th class="gg" align="center"><?php echo   $row_veiculo['nome'] ;?></th>
			<td class="gg" align="center"><?php echo  $row_veiculo['name'] ;?></td>
			<td class="gg" align="center"><?php echo   $row_veiculo['nomeD'] ;?></td>
			<td class="gg" align="center"><?php echo  $row_veiculo['nomeP'] ;?></td>
			<td class="gg" align="center"><?php echo   $row_veiculo['nomeS'] ;?></td>
			<td class="gg" align="center"><?php echo  $row_veiculo['carga'] ;?></td>
			<td class="gg" align="center"><?php echo   $row_veiculo['horario'] ;?></td>
			<td class="gg"><center><img class='bgSizeContain' src="<?php echo  $row_veiculo['alocado'] ;?>.gif" /></center></td>
			</tr>
			<?php
		}?>
