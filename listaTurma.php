...
$result_veiculos = "SELECT * FROM turma";
  ...
  width: 600px;
   ...
   .button {
	...
	<td class="gg"><img src="logo.png" width="300" height="80"></td>
	 <td class="gg">
				<a href="../TCC/cadastrarTurma.php"><button class="btNovo" >Novo Turma</button></br><br>
	...
	<br><br><center><h1>Turmas Cadastradas</h1></center><br>
	<div>
	...
	<?php
		...
		while($row_veiculo = mysqli_fetch_assoc($result_veiculos)){
			?>
			<tr class="trgg">
			<th class="gg" align="center"><?php echo   $row_veiculo['name'] ;?></th>
			<td class="gg" align="center"><?php echo  $row_veiculo['semestre'] ;?></td>
			<td class="gg" align="center"><?php echo   $row_veiculo['id_curso'] ;?></td>
			</tr>
			<?php
		}?>
