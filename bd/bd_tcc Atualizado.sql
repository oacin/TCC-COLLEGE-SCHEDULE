...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Out-2022 às 19:56
...
--
DELIMITER $$
CREATE TRIGGER `novo_status` AFTER INSERT ON `alocar` FOR EACH ROW update aula
INNER JOIN alocar ON
aula.idAula = alocar.aulaAula
set aula.alocado = 1
where alocar.semanaS != 0 or 'NULL'
$$
DELIMITER ;
DELIMITER $$
...
(4, 6, 4, 4, '44444444444', 4, 250, '00:00:00', 1);
...
INSERT INTO `curso` (`id`, `nome`, `quantidadeAluno`, `periodo`, `qtdSemestre`, `statusCurso`) VALUES
(1, 'Ciencia da Computação', 30, 'Noite', 8, 1),
(2, 'Engenharia de controle e automação', 30, 'Noite', 10, 1),
(5, 'aaaa', 122, 'aaa', 8, 1),
(6, 'Engenharia Quimica', 15, 'Integral', 8, 0),
(8, 'a', 1, 'a', 1, 1);
...
INSERT INTO `disciplina` (`id`, `nomeD`, `semestre`, `idcurso`, `statusDis`) VALUES
(1, 'Banco de dados I', '3', 1, 0),
(2, 'Algebra Linear', '1', 1, 1),
(3, 'IHM', '8', 1, 0),
(4, 'Quimica', '4', 6, 0);
...
INSERT INTO `professor` (`cpf`, `nomeP`, `salario`, `data_nascimento`, `formacao`, `idDisciplina`, `periodo`, `statusProfessor`) VALUES
('29677512005', 'Testeee', 3900, '1990-02-14', 'Teste', 2, 'Noite', 1),
('44444444444', 'Miquelino', 4500, '2022-10-10', 'teste', 4, 'Integral', 1),
('80469470836', 'Valeria Almeida', 3000, '1998-05-15', 'Analista de dados ', 3, 'Noite', 1),
('93573727760', 'Hyan Daniel', 3000, '1995-08-01', 'Banco de dados ', 1, 'Noite', 0);
