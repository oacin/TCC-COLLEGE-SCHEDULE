  ...
  width: 600px;
   ...
   .button {
	...
	<td class="gg"><img src="logo.png" width="300" height="80"></td>
	 <td class="gg">
				<a href="../TCC/cadastrarSala.php"><button class="btNovo" >Nova sala</button></br><br>
	...
	<br><br><center><h1>Salas Cadastradas</h1></center><br>
	<div>
	...
	<thead>
			<tr class="trgg" >
				...
				<th class="gg" align="center">Numero</th>
	...
	<?php
		...
		while($row_veiculo = mysqli_fetch_assoc($result_veiculos)){
			?>
			<tr class="trgg">
			<th class="gg" align="center"><?php echo   $row_veiculo['nomeS'] ;?></th>
			<td class="gg" align="center"><?php echo  $row_veiculo['numero'] ;?></td>
			<td class="gg" align="center"><center><img class='bgSizeContain' src="<?php echo  $row_veiculo['status'] ;?>.gif" /></center></td>
			</tr>
			<?php
		}?>
